    ...
    public static void main(String[] args) {
        try {
            ...
            try {
                ...
                feedback += "Passed no error thrown. ";
            } catch (Exception e) {
                feedback += "Failed, error thrown. ";
            }
            ...
            feedback += "\n500 requested.  Generator produced: " + res + "\n";

            String[] words = res.split("[\\s]+");
            feedback += "\n** Test #3: Checking requested generator word count...";
            feedback += "500 requested.  Your generator produced " + words.length + " words. ";
            ...
            words = res.split("[\\s]+");
            int i = 0;
            feedback += "\n** Test #8: Running train() on a generator that has already been trained (should be ignored)...";
            for (String w : words) {
                if (w.equals("I")) {
                    i++;
                }
            ...
            gen.retrain("");
            feedback += "\n** Test #9: Testing retrain() with empty retraining data...";
            String s = gen.generateText(20);
