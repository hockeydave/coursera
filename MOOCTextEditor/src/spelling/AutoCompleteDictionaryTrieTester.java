...
public class AutoCompleteDictionaryTrieTester {
	...
	public void testAddWord()
	{
		...
		assertEquals("Asserting hellow is in empty dict after insertion", true, emptyDict.isWord("hellow"));
		assertEquals("Asserting hellow is in small dict after insertion", true, smallDict.isWord("hellow"));
		assertEquals("Asserting hellow is in large dict after insertion", true, largeDict.isWord("hellow"));
